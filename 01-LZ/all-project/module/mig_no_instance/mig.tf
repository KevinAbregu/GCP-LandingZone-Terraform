data "google_compute_instance_template" "instante_template"{
    name = var.mig.instance_template
    project = var.mig.project_id
}
...
# Autoscaler
    ...
    instance_template   = data.google_compute_instance_template.instante_template.self_link
}